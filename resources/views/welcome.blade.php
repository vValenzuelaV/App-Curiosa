...
@section('content')
    <div class="welcome-container">
        ...
        <div class="intro-letter">
            <p>
                Fernanda, la verad se que las palabras son fragiles y más si no puedo hacer nada por tener esa cercania que
                me gustaria tener y la cual perdi todo el derecho, las disculpas solo tienen valor si vienen acompañadas de
                cambios verdaderos lo tengo más que claro, hay tantas cosas que me gustaria poder dercirte pero las cuales
                yo mismo arranque de mi instancia para decirlas.
            </p>
            <br>
            <p>
                Por eso diseñé este sitio. Buscaba esa posibilidad de poder darte algunas de las tantas cosas que quisera
                darte sin presionarte o incomdarte más de lo que mi precencia lo hace.
            </p>
            <br>
            <p>
