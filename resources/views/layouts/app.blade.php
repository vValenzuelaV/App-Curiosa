...
<body>
            ...
            <nav>
                <ul class="nav-menu">
                    @if(session()->has('visitor_name') || Auth::check())
                        ...
                        <li class="nav-item-main">
                            <a href="{{ route('dibujos') }}" class="nav-link {{ Route::is('dibujos') ? 'active' : '' }}">
                                Dibujos
                            </a>
                        </li>
                        <li class="nav-item-main">
    ...
    @if(session()->has('visitor_name') || Auth::check())
        <div class="mobile-bottom-nav">
            ...
            <a href="{{ route('dibujos') }}" class="mobile-nav-item {{ Route::is('dibujos') ? 'active' : '' }}">
                <svg class="mobile-nav-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <span class="mobile-nav-label">Dibujos</span>
            </a>
